...
//!
//! This first piece provides the ML-KEM-768 parameter set (FIPS 203, security category 3) together
//! with the polynomial arithmetic it is built on: the number theoretic transform, modular
//! reduction, the base ring multiplication, the compression and decompression, and the byte
//! encodings.
